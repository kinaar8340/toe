...
def main():
    ...
    ax.axis("off")
    table = ax.table(
        cellText=top10.round(5).values, colLabels=top10.columns, cellLoc="center", loc="center"
    )
